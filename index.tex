...
\begin{tcolorbox}[enhanced jigsaw, titlerule=0mm, toptitle=1mm, colback=white, opacitybacktitle=0.6, leftrule=.75mm, bottomtitle=1mm, arc=.35mm, toprule=.15mm, colbacktitle=quarto-callout-tip-color!10!white, left=2mm, breakable, title=\textcolor{quarto-callout-tip-color}{\faLightbulb}\hspace{0.5em}{Answer}, bottomrule=.15mm, rightrule=.15mm, opacityback=0, coltitle=black, colframe=quarto-callout-tip-color-frame]
