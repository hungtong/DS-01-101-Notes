...
\begin{tcolorbox}[enhanced jigsaw, opacitybacktitle=0.6, bottomrule=.15mm, leftrule=.75mm, title=\textcolor{quarto-callout-tip-color}{\faLightbulb}\hspace{0.5em}{Answer}, arc=.35mm, opacityback=0, bottomtitle=1mm, colback=white, breakable, colframe=quarto-callout-tip-color-frame, titlerule=0mm, rightrule=.15mm, toprule=.15mm, left=2mm, colbacktitle=quarto-callout-tip-color!10!white, coltitle=black, toptitle=1mm]
